    ...
    return (
      <div>
        ...
        <div id='inputs'>
          ...
          />
          <button onClick={handleAddDevice} id="botao">Adicionar Dispositivo</button>
        </div>
        <section id='conteudo_list'>
          ...
          <button id='botao_baixo' onClick={calculateMonthlyEnergyUsage}>Calcular Consumo Diario & Mensal</button>
        </div>
        </section>
